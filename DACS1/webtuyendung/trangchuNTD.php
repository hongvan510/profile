...
<p style="background-color: #1d9c1b; width:max-content; padding:6px 8px; color: #fff;">
    Tổng việc làm hiện có : <?php echo $total_vieclam ?></p>
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo "</div>";
        echo "<a href='thongtin.php'><button class='ungtuyen'  type='submit'>Ứng tuyển</button></a>";
        echo "<form method='POST' action='' class='delete-form'>";
        echo "<input type='hidden' name='delete' value='" . $row['MaNhaTD'] . "'>";
        echo "<button class='xoavieclam' style='width: 100px; margin-bottom:-70px;transform: translateY(15px); ' type='submit'>Xóa</button>";
        echo "</form>";
        echo "</div>";
    }
    echo "</div>";
